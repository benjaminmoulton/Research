...
fishbone = BoneMaker( airfoil, startperc, endperc, boneWidth, gapWidth,
              spineWidth, tribase, isTlocal, ledgeWidth, ledgeDepth, ledgeIsFlat,True,percent_r)


fishbone.plot()
fishbone.plot([fishbone],axis = [0.55,0.65,-0.1,0.1],display = ['o'])
fishbone.plot([fishbone],display = ['o'])
