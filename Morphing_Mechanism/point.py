...
#        for i in range(len(self.points)):
#            if(type ( self.points[i].x ) == n.ndarray): 
#                print( type ( self.points[i].x )); print(self.points[i].x)
#            if(type ( self.points[i].y ) == n.ndarray): 
#                print( type ( self.points[i].y )); print(self.points[i].y)
#            if(type ( self.points[i].z ) == n.ndarray): 
#                print( type ( self.points[i].z )); print(self.points[i].z)
        if(type(self.points[0].x ) == n.ndarray or type(self.points[len(self.points)-1].x ) == n.ndarray or
           type(self.points[0].y ) == n.ndarray or type(self.points[len(self.points)-1].y ) == n.ndarray or
           type(self.points[0].z ) == n.ndarray or type(self.points[len(self.points)-1].z ) == n.ndarray):
            if (n.round(self.points[len(self.points)-1].x,5) != n.round(self.points[0].x,5) or 
                n.round(self.points[len(self.points)-1].y,5) != n.round(self.points[0].y,5) or 
                n.round(self.points[len(self.points)-1].z,5) != n.round(self.points[0].z,5)):
