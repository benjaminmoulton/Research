...
if __name__ == "__main__":
    ...
    print("tapered cylinder eqs...")
    m = simp( V_ints[0].subs({az0:ay0,az1:ay1}) )
    cglist = ["x","y","z"]
    prodlist = ["xy","xz","yz"]
    prodcglist = [(0,1),(0,2),(1,2)]
    momlist = ["xx","yy","zz"]
    ...
    for q in range(len(V)):
        iii = simp( V_ints[q].subs({az0:ay0,az1:ay1}) )
        if q == 0:
            print("V = {}".format(simp(m/p)))
            print("m = {}".format(m))
        elif q < 4:
            ...
            ii0 = simp( V_ints[momlisti[q-7][0]].subs({az0:ay0,az1:ay1}) )
            ii1 = simp( V_ints[momlisti[q-7][1]].subs({az0:ay0,az1:ay1}) )
            cg0 = cg[momcglist[q-7][0]]
            cg1 = cg[momcglist[q-7][1]]
            I = simp(mp*( (ii0+ii1)/m - cg0**2 - cg1**2) )
            print("I{} = {}".format(momlist[q-7],I))
