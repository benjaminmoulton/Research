...
if __name__ == "__main__":
    ...
    e = (- 8820*cr**6*tr**3 - 4900*cr**6*tr**2*tt - 2450*cr**6*tr*tt**2 - 1050*cr**6*tt**3
         - 9800*cr**5*ct*tr**3 - 14700*cr**5*ct*tr**2*tt - 18900*cr**5*ct*tr*tt**2 + 8400*cr**5*ct*tt**3
         - 12250*cr**4*ct**2*tr**3 - 47250*cr**4*ct**2*tr**2*tt + 63000*cr**4*ct**2*tr*tt**2 + 21000*cr**4*ct**2*tt**3
         - 21000*cr**3*ct**3*tr**3 + 84000*cr**3*ct**3*tr**2*tt + 84000*cr**3*ct**3*tr*tt**2 - 21000*cr**3*ct**3*tt**3
         + 21000*cr**2*ct**4*tr**3 + 63000*cr**2*ct**4*tr**2*tt - 47250*cr**2*ct**4*tr*tt**2 - 12250*cr**2*ct**4*tt**3
         + 8400*cr*ct**5*tr**3 - 18900*cr*ct**5*tr**2*tt - 14700*cr*ct**5*tr*tt**2 - 9800*cr*ct**5*tt**3
         - 1050*ct**6*tr**3 - 2450*ct**6*tr**2*tt - 4900*ct**6*tr*tt**2 - 8820*ct**6*tt**3
    )
    el= ln(rr/rt)* (
         - 8400*cr**5*ct*tt**3
         - 63000*cr**4*ct**2*tr*tt**2
         + 21000*cr**4*ct**2*tt**3
         - 84000*cr**3*ct**3*tr**2*tt
         + 84000*cr**3*ct**3*tr*tt**2
         - 21000*cr**2*ct**4*tr**3
         + 63000*cr**2*ct**4*tr**2*tt
         + 8400*cr*ct**5*tr**3
    )
